...
set output "erreur_H1_vitesse_non_linear_P2_pas.pdf" 
...
set title "u(x,y)=x , v(x,y) = -y , p(x,y)= x+y+c" 
set output "erreur_H1_pression_non_linear_P2_pas.pdf" 
...
set ylabel "erreur H1 pour la vitesse" 
set title "u(x,y)=x , v(x,y) = -y , p(x,y)= x+y+c" 
set output "erreur_H1_vitesse_non_linear_P2_penal.pdf" 
