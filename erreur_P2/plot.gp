...
set output "erreur_H1_vitesse_linear_P2_pas.pdf" 

plot "error_pas_1_P2.txt" u 1:2 w lp ls 1  


set xlabel "pas de maillage" 
set ylabel "erreur H1 pour la pression" 
set title "u(x,y)=x , v(x,y) = -y , p(x,y)= x+y+c" 
set output "erreur_H1_pression_linear_P2_pas.pdf" 

plot "error_pas_1_P2.txt" u 1:3 w lp ls 1 


set xlabel "coéfficient de pénalisation" 
set ylabel "erreur H1 pour la vitesse" 
set title "u(x,y)=x , v(x,y) = -y , p(x,y)= x+y+c" 
set output "erreur_H1_vitesse_linear_P2_penal.pdf" 


plot[1e-10:0.01][1e-13:0.01] "error_penal_1_P2.txt" u 1:2 w lp ls 1   


set xlabel "coéfficient de pénalisation" 
set ylabel "erreur H1 pour la pression" 
set title "u(x,y)=x , v(x,y) = -y , p(x,y)= x+y+c" 
set output "erreur_H1_pression_linear_P2_penal.pdf" 

plot[1e-10:0.01] "error_penal_1_P2.txt" u 1:3 w lp ls 1  
