...
set xlabel "coefficient de pénalisation" 
set ylabel "erreur H1 en vitesse" 
set output "erreur_3D_vitesse.pdf" 

plot[1e-11:0.01][1e-11:0.01] "error_penal_3D.txt" u 1:2 w lp ls 1  

set xlabel "coeffcient de pénalisation" 
set ylabel "erreur H1 en pression" 
set output "erreur_3D_pression.pdf"

plot[1e-11:0.01] "error_penal_3D.txt" u 1:3 w lp ls 1 