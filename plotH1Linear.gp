...
set title "u(x,y) = x^2 , v(x,y) = y^2 , p(x,y) = x^2+y^2+c" 
set output "errer_U_non_linear_pas.pdf" 
plot  "error_pas_1_non_linear.txt" u 1:2 w lp ls 1  

set xlabel "pas de maillage" 
set ylabel "erreur H1 pour la pression" 
set title "u(x,y) = x^2 , v(x,y) = y^2 , p(x,y) = x^2+y^2+c" 
set output "errer_P_non_linear_penal.pdf" 
plot "error_penal_1_non_linear.txt" u 1:3 w lp ls 1 
